...
const Header = (props:{LeftNave:React.ReactNode,RightNave:React.ReactNode}) => {
  ...
  const links = [
    ...
    return (
        ...
        <div className=" flex w-full gap-6 rounded-b-2xl border border-solid border-gray-700 bg-gray-800 p-1 shadow-xl ">
          <div className="flex h-9 w-full items-center justify-between gap-0 ">
            <a
              href="/"
          ...
          <div className="flex h-9 w-full items-center justify-end gap-0  md:hidden">
           
            <div className="flex h-full w-fit items-center gap-x-2 md:hidden">
              <a
                className="h-full"
                href="https://app.skiff.com/signin?pt=2.0%3A+Privacy-first%2C+end-to-end+encrypted+email+%28with+color%29.&agid=undefined&aid=undefined&gclid=undefined"
              >
                <span className="body-small ml-2 flex h-full cursor-pointer items-center rounded-xl bg-white px-3 font-medium text-black hover:opacity-[.9]">
                  Sign in
                </span>
              </a>
